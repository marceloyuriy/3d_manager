...
# Configurações para upload de arquivos (Media)
# MEDIA_URL é o prefixo do link no navegador
MEDIA_URL = '/media/'
# MEDIA_ROOT é a pasta física no seu computador/servidor onde os arquivos serão salvos
MEDIA_ROOT = BASE_DIR / 'media'

# --- CONFIGURAÇÕES DE LOGIN / LOGOUT ---

# Diz ao Django para qual página ir APÓS o login com sucesso.
# 'lista_fila' é o nome da rota da nossa página inicial.
